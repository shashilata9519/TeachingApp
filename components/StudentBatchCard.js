...
export default function StudentBatchCard(props) {
    ...
    return <View style={{ padding: 16, backgroundColor: '#FFF', borderRadius: 12, margin: 16, marginTop: 8, marginBottom: 8, width: 350, }}>
        ...
        <Text style={{ fontSize: 15, fontWeight: 'bold' }}>"Teacher's Name"</Text>
        </View>
        ...
        {/* <Text style={{ fontSize: 17, fontWeight: 'bold',textAlign:'center' }}>Card 1 (Batches card)</Text> */}
            <Text style={{ fontSize: 17, fontWeight: 'bold' }}>Course: <Text style={{fontSize: 14,fontWeight: 'normal' }} numberOfLines={2}>Gandharva Madhyama Pratham </Text></Text>
        ...
        <TouchableOpacity  style={{ paddingRight: 10, justifyContent: "center", backgroundColor: '#a9a9a9',  borderRadius: 10, marginLeft:0}}>
                  ...
                  <View style={{ padding: 4, backgroundColor: '#FFF', borderRadius: 12, margin: 5, marginTop: 10, marginBottom: 10, alignItems: "center", }}>
                    ...
                    <Text style={{ fontSize: 14, paddingHorizontal: 8,marginBottom: 5, backgroundColor:"#228b22", borderRadius:10, fontWeight:'bold' }}>Scheduled</Text>
              ...
              {/* Action buttons */}
              <View style={{alignItems:"center", paddingTop: 2 , paddingBottom: 0}}>
                    <Text style={{fontSize: 17, fontWeight: 'bold', paddingBottom:0}}>Fees: Rs. 5000</Text>
