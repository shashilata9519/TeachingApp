  ...
  const ContentView = () => {
    return (
      <View>
        ...
        >
           <Text style={{ color: "#000", fontSize: 20, fontWeight: 600, alignItems:"center", paddingTop:5 }}>  My Profile</Text>
            {/* <View style={{flexDirection: 'row',paddingTop:20, paddingLeft:10, }}>
                                <View style={{flexDirection: 'row', paddingHorizontal:15 }}>
                                        <TouchableOpacity style={tw`border-red-10 border rounded-full p-2 bg-amber-500  w-23`}>
                                                <Text style={{fontWeight:"bold", textAlign:"center"}}>Pending</Text>
                                        </TouchableOpacity>
                                </View>
                                <View style={{flexDirection: 'row', paddingHorizontal:15 }}>
