  ...
  const ContentView = () => {
    return (
      <View>
        ...
        >
           <Text style={{ color: "#000", fontSize: 20, fontWeight: 600, alignItems:"center", paddingTop:5   }}>   Purchase History</Text>
...
export default withNavigation(PurchaseHistoryScreen);
